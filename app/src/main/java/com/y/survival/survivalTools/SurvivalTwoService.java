                ...
                switch (msg.what) {
                    case 1:
                        if (SurvivalData.I().survivalUtil != null) {
                            ...
                            } else if ((System.currentTimeMillis() - SurvivalOneService.sSurvivalOneTime) > 60 * 1000) {
                                SurvivalData.I().survivalUtil.startService2();
                            }
                        }
                        mHandler.sendEmptyMessageDelayed(1, 30 * 1000);
                        if (SurvivalData.I().survivalListener != null) {
                            SurvivalData.I().survivalListener.onHeartbeat(2);
